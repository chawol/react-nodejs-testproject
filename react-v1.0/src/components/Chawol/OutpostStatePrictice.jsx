...
class EasyFormTemp extends React.Component {
    constructor(props) {
        super(props)
...
export class MessageBlock extends React.Component {
    constructor(props) {
        super(props)
        this.state = ({style: {backgroundColor: '#136962', height: 200, width: '100%'}})
    }
...
class Message extends React.Component {
    constructor(props) {
        super(props)
        this.state = ({style: {backgroundColor: '#2f23ff', height: 100, width: '80%'}})
    }

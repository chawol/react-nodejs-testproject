        ...
        return (
            <div className="InputTaskForm">
                <div className="InputTask">
                    <InputName className="fas fa-calendar-alt" inputName="Deadline"></InputName>
                    ...
                    <div className="inputForm">
                        <input type="file" className="inputStyle"/><br/>
                ...
                <div>
                    <button type="button" className="addButton cancelButton" onClick={this.props.closeAdd}> Ｘ Cancel
                    </button>
